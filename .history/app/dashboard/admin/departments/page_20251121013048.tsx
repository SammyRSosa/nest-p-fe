...
export default function DepartmentsPage() {
  ...
  const getStats = () => {
    // ✅ PROTECCIÓN CONTRA UNDEFINED - ESTO ARREGLA EL ERROR
  ...
  // ✅ FUNCIÓN SEGURA PARA CALCULAR MEDICAMENTOS TOTALES
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === "list" && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              {/* ✅ CORREGIDO - USANDO LA FUNCIÓN SEGURA */}
      ...
      {activeTab === "list" ? (
        <DepartmentTable
          departments={departments || []} {/* ✅ PROTECCIÓN AQUÍ TAMBIÉN */}
