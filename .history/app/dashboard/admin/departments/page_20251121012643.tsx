...
export default function DepartmentsPage() {
  ...
  const getStats = () => {
    ...
    const totalWorkers = departments.reduce(
      (sum, d) => sum + (d.workers?.length || 0),
      0
    );
    const criticalStock = departments.reduce(
      (sum, d) =>
        sum +
        (d.medicationStock?.filter((m) => m.status === "critical").length || 0),
      0
    );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Administra los departamentos del policlínico, personal y stock de
            medicamentos
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {departments.reduce(
                  (sum, d) => sum + d.medicationStock.length,
                  0
                )}
              </div>
              <p className="text-xs text-muted-foreground">
      ...
      {activeTab === "list" ? (
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Genera reportes detallados del consumo de medicamentos por
                departamento y período.
              </p>
            </CardContent>
          </Card>
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-muted-foreground text-center max-w-md">
                  Aquí se mostrarán los reportes de consumo de medicamentos por
                  departamento.
                </p>
              </CardContent>
            </Card>
          ...
          {selectedDepartment && (
            <div className="space-y-6">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {selectedDepartment.workers.length} trabajadores
                      </p>
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardContent>
                  {selectedDepartment.workers.length === 0 ? (
                    <p className="text-muted-foreground">
              ...
              <Card>
                ...
                <CardContent>
                  {selectedDepartment.medicationStock.length === 0 ? (
                    <p className="text-muted-foreground">
                        ...
                        >
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              ...
                              {medication.maxQuantity} {medication.unit}
                            </p>
                          </div>
