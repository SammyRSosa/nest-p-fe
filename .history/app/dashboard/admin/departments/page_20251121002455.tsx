...
export default function DepartmentsPage() {
  ...
  const getStats = () => {
    ...
    const totalWorkers = departments.reduce((sum, d) => sum + d.workers.length, 0)
    const criticalStock = departments.reduce((sum, d) => 
      sum + d.medicationStock.filter(m => m.status === 'critical').length, 0
    )
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {departments.reduce((sum, d) => sum + d.medicationStock.length, 0)}
              </div>
              <p className="text-xs text-muted-foreground">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{selectedDepartment.workers.length} trabajadores</p>
                    </div>
                  </div>
