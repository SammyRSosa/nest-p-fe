...
export function StaffAssignmentDialog({
 ...
 const fetchAssignments = async () => {
  ...
  try {
    ...
    toast({
      title: "Error",
      description: error instanceof Error ? error.message : "Error al asignar trabajador",
      variant: "destructive",
    });
  } finally {
    setLoading(false);
...
const removeWorker = async (assignmentId: string) => {
  ...
  try {
    ...
    toast({
      title: "Error",
      description: error instanceof Error ? error.message : "Error al remover trabajador",
      variant: "destructive",
    });
  } finally {
    setLoading(false);
