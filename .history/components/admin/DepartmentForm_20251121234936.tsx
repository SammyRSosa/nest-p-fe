...
export function DepartmentForm({
  ...
  const fetchWorkers = async () => {
    try {
      ...
      // Filtrar solo los workers con rol "head_of_department"
      const headsOfDepartment = data.filter(
        (worker: User) => worker.role === "head_of_department"
      );

      console.log("👑 Heads of department:", headsOfDepartment);
      setWorkers(headsOfDepartment);
      console.log(headsOfDepartment.name)
    } catch (error) {
