...
import { Building2, Users, MoreHorizontal, Edit, Trash2, Eye, Package, UserCheck } from "lucide-react"
...
export function DepartmentTable({ 
  ...
  const getStockStatusBadge = (department: Department) => {
    const criticalStock = department.medicationStock.filter(item => item.status === 'critical').length
    const lowStock = department.medicationStock.filter(item => item.status === 'low').length
                ...
                <TableRow key={department.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      ...
                      <span>{department.medicationStock.length}</span>
                    </div>
                  </TableCell>
                  <TableCell>
