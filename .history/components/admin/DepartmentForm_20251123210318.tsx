// 📁 DepartmentForm.tsx - CORREGIR USO DE TIPOS
"use client";
...
import type { Department, User, DepartmentCreateRequest, DepartmentUpdateRequest } from "@/types";
...
interface FormData {
  name: string;
  headWorkerId: string; // ✅ CAMBIADO a headWorkerId
}
...
export function DepartmentForm({
  ...
  const onSubmit = async (data: FormData) => {
    ...
    console.log("🏢 Departamento actual:", department);
